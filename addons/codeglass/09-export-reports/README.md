...
Reliable normalized JSON and HTML finished-project exports.
...
Run `apply.ps1` from PowerShell with the Code Glass project path configured. The installer copies this package under `addons/codeglass/09-export-reports` and creates an integration note. Source-level wiring is described in `INTEGRATION.md`.
