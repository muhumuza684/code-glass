...
Layered transparent glass visual system, responsive layout, status language, and whole-section impact.
...
Run `apply.ps1` from PowerShell with the Code Glass project path configured. The installer copies this package under `addons/codeglass/07-glass-responsive-ui` and creates an integration note. Source-level wiring is described in `INTEGRATION.md`.
